    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
      ...
      <div className="flex flex-wrap gap-2 sm:gap-3 mb-6 sm:mb-8">
        <input
          ...
          className="border border-gray-200 rounded-lg px-3 sm:px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gold-400/50 bg-white w-full sm:w-auto"
        />
        <select
          value={filterCollection}
          onChange={e => setFilterCollection(e.target.value)}
          className="border border-gray-200 rounded-lg px-3 sm:px-4 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-gold-400/50 flex-1 sm:flex-none"
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-6">
        {filtered.map(product => (
          ...
          >
            {/* Product image */}
            <div className="h-40 sm:h-56 relative overflow-hidden bg-gray-100">
              {product.ImageUrl ? (
                <Image
            ...
            <div className="p-3 sm:p-5">
              ...
              <h3 className="font-semibold text-charcoal mb-1 sm:mb-2 text-sm sm:text-base">{product.Name}</h3>
              ...
              <div className="flex items-center justify-between mb-2 sm:mb-3">
                <span className="text-base sm:text-lg font-bold">{formatCurrency(product.RetailPrice)}</span>
